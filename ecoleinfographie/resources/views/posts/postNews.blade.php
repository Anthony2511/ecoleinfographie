		...
		<div class="comments__wrapper">
			<div class="comments__header">
				...
				<div class="comments__share">
                    ...
                    --><li class="social-list-circle__item">
							<a href="https://pinterest.com/pin/create/bookmarklet/?media={{ $article->image }}&url={{ Url()->current() }}&description={{ $article->metadescription }}" class="social-list-circle__link pinterest" rel="me"><span>Partager l’article sur Pinterest</span></a>
						</li><!--
                    --><li class="social-list-circle__item">
