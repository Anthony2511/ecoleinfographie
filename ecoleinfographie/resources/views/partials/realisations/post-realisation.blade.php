<div class="rea__container">
    <section class="rea">
        <h2 role="heading" aria-level="2" class="rea__name">Sur un Baobab</h2>
        <span class="rea__author">Par <a href="#jimmyletecheur" class="rea__link" rel="author" title="Voir les autre projets de Jimmy Letecheur">Jimmy Letecheur</a></span>
            ...
            <div class="rSlider__container">
                <ul class="rSlider">
                    ...
                    <li class="rSlider__item" data-thumb="./img/rea-three.png">
                        <img class="rSlider__img" src="./img/rea-three.png" width="947" height="532" alt="#alt">
                    </li>
            ...
            <aside class="rea-infos rea-infos--with-button">
                ...
                <dl class="rea-infos__list">
                    <dt class="rea-infos__term">Orentation</dt>
                        <dd class="rea-infos__data">Web</dd>
                    <dt class="rea-infos__term">Année de réalisation</dt>
                        <dd class="rea-infos__data">2016</dd>
                    <dt class="rea-infos__term">Type de projet</dt>
                        <dd class="rea-infos__data">Site web</dd>
                    <dt class="rea-infos__term">Cadre</dt>
                        <dd class="rea-infos__data">Cours de design web</dd>
                        <dd class="rea-infos__data">Projet pour un client</dd>
                </dl>
                <div class="rea-share">
