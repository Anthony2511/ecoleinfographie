<article class="blog-card">
	<a href="{{ $article->slug }}" class="blog-card__go-article"><span>Lire l’article {{ $article->title }}</span></a>
	<header class="blog-card__header">
		<a href="#category" class="blog-card__category blog-card__category--{{ $article->orientation }}">{{ $orientation[$article->orientation] }}</a>
	...
	<h3 role="heading" aria-level="3" class="blog-card__title">{{ str_limit($article->title, 55, '…') }}</h3>
	<footer class="blog-card__footer">
		<a href="#author" class="blog-card__author" rel=author>
			...
			<span class="blog-card__author__name">
              ...
              <?php var_dump($article->teacher->fullname); ?>
					</span>
				</span>
			</span>
		</a>
