<div class="header__wrapper">
    <nav class="nav">
        <ul class="menu">
            <li class="menu__item">
                <a href="#1" class="menu__link">Les métiers</a>
                <div class="subnav subnav__jobs">
                    ...
                    <ul class="subnav__group">
                        <li>
                            <a href="" class="subnav__jobs__job">
                                ...
                                <img class="subnav__jobs__menuicon" src="../img/2D-menu.png"
                                     srcset="../img/2D-menu@2x.png 2x"
                                     width="30" height="30" alt="" >
                            </a>
                        </li>
                        <div class="subnav__link-wrapper">
                    ...
                    <ul class="subnav__group">
                        <li>
                            <a href="" class="subnav__jobs__job">
                                ...
                                <img class="subnav__jobs__menuicon" src="../img/3D-menu.png"
                                     srcset="../img/3D-menu@2x.png 2x"
                                     width="30" height="30" alt="" >
                            </a>
                        </li>
                        <div class="subnav__link-wrapper">
                    ...
                    <div class="subnav__jobs__town">
                        <svg width="651" height="154" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="menu__item">
                <a href="#2" class="menu__link">L’école</a>
                <div class="subnav subnav__school">
                    ...
                    <div class="subnav__school__svg-wrapper">
                        <svg class="subnav__school__building" width="81" height="66" xmlns="http://www.w3.org/2000/svg">
                            <g fill="#F5F5FA">
                        ...
                        <svg class="subnav__school__trees1" width="112" height="34" xmlns="http://www.w3.org/2000/svg">
                            <g fill="#F5F5FA">
                        ...
                        <svg class="subnav__school__trees2" width="120" height="33" xmlns="http://www.w3.org/2000/svg">
                            <g fill="#F5F5FA">
            ...
            <li class="menu__item">
                <a href="#3" class="menu__link">Réalisations</a>
            </li>
            <li class="menu__item">
